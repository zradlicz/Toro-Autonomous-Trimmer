# -*- coding: utf-8 -*-
"""
Created on Tue Jan 26 12:42:56 2021
...
source_folder = os.path.join(os.getcwd(), "Rancho Del Pueblo 2nd Half")
json_path = "ranchodelpueblo2_json.json"                     # Relative to root directory
...
for itr in file_bbs:
    ...
    image_folder = os.path.join(to_save_folder, "images")
    #print(itr)
    img_path = os.path.join(image_folder,itr+'.jpg')
    img = cv2.imread(img_path)
    try:
        MASK_WIDTH,MASK_HEIGHT,throwaway = img.shape
    except:
        pass
